...
import name.trifon.beeserver.config.Constants;
import name.trifon.beeserver.domain.User;
import name.trifon.beeserver.repository.AuthorityRepository;
import name.trifon.beeserver.repository.UserRepository;
import name.trifon.beeserver.security.AuthoritiesConstants;
import name.trifon.beeserver.service.UserService;
import name.trifon.beeserver.service.dto.PasswordChangeDTO;
import name.trifon.beeserver.service.dto.UserDTO;
import name.trifon.beeserver.web.rest.vm.KeyAndPasswordVM;
import name.trifon.beeserver.web.rest.vm.ManagedUserVM;
...
import static name.trifon.beeserver.web.rest.AccountResourceIT.TEST_USER_LOGIN;

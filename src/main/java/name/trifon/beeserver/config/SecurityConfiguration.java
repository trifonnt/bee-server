...
import name.trifon.beeserver.security.*;
import name.trifon.beeserver.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.POST, "/api/measurement-records").permitAll() //@Trifon - allow POST

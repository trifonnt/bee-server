...
@RestController
@RequestMapping("/api/bee-server-kafka")
public class BeeServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BeeServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BeeServerKafkaResource(KafkaProperties kafkaProperties) {
